...
I was tired of closing the banner manually so I decided to create an extension that would do the job for me.
...
# How to use?
The extension will remove the annoying banner everytime you visit either __www.roblox.com__ or __web.roblox.com__ (for accounts with age under 13)
